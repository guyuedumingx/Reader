...
public class BookList {
    ...
    public BookList(String tag, String sourceName, BookSourceBean bookSourceBean, boolean isFind) {
        this.tag = tag;
...
//    }
    ...
    public SearchBookBean getItemInList(AnalyzeRule analyzer, String baseUrl, boolean printLog) throws
            Exception {
        SearchBookBean item = new SearchBookBean();
        analyzer.setBook(item);
        Debug.printLog(tag, 1, "┌获取书名", printLog);
    ...
    private void getBooksOfRegex(String res, String[] regs,
        ...
        if (index + 1 == regs.length) {
            ...
            for (String key : ruleMap.keySet()) {
                ...
                ruleName.add(key);
                hasVarParams.add(!isEmpty(val) && (val.contains("@put") || val.contains("@get")));
...
class Debug{
    static void printLog(Object...objects) {
